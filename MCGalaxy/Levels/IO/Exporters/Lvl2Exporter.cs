...
namespace MCGalaxy.Levels.IO {
    ...
    /// <summary>
    /// A new version of the LVL format, designed to store additional block "transient data" for MCGalaxy-X, such as health, strength, and anything else I may come up with.
    /// </summary>
    public unsafe sealed class Lvl2Exporter : IMapExporter {

        public override string Extension { get { return ".lvl2"; } }
        ...
        public override void Write(Stream dst, Level lvl)
        {
            using (Stream gs = new GZipStream(dst, CompressionMode.Compress)) {
                ...
                lock (lvl.physTickLock)
                {
                    ...
                    //WriteTransientDataSection(lvl, gs, buffer);
                }
        ...
        {
            WriteU16(header,  0, 1875); // 0x1875 - lvl1 = 0x1874
